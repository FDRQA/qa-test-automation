...
# 4️⃣ ESCRIBIR EMAIL CORRECTO USANDO `CTRL + V`
print("✅ Escribiendo email correcto...")
pyperclip.copy("fatima@internxt.com")
...
# 7️⃣ ESCRIBIR CONTRASEÑA INCORRECTA USANDO `CTRL + V`
print("❌ Escribiendo contraseña incorrecta...")
pyperclip.copy("Morgana.00@")  # Contraseña errónea a propósito
pyautogui.hotkey("ctrl", "v")
time.sleep(1)
...
print("🚀 Test de login con contraseña incorrecta completado.")
