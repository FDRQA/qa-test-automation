...
# ============================
# 3️⃣ INGRESAR EMAIL CORRECTO
# ============================
print("📌 Escribiendo email correcto...")
...
email = "fatima@internxt.com"  # Email correcto
...
# ============================
# 4️⃣ INGRESAR CONTRASEÑA INCORRECTA
# ============================
print("🔐 Escribiendo contraseña incorrecta...")
...
password = "ContraseñaErrónea123!"  # Contraseña incorrecta
pyperclip.copy(password)
pyautogui.hotkey("command", "v")  # Pegar la contraseña
time.sleep(1)

print("✅ Contraseña ingresada incorrectamente (como se esperaba).")
...
error_message_path = "error_contraseña.png"
screenshot.save(error_message_path)

print(f"📸 Captura de pantalla guardada: {error_message_path}")
print("🚫 ERROR: No se pudo iniciar sesión con la contraseña incorrecta.")