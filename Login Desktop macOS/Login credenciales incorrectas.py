...
email = "correo_incorrecto@internxt.com"  # Email incorrecto
...
error_message_path = "error_email_contraseña.png"
screenshot.save(error_message_path)

print(f"📸 Captura de pantalla guardada: {error_message_path}")
print("🚫 ERROR: No se pudo iniciar sesión con email y contraseña incorrectos.")