...
pyperclip.copy("correo_falso@internxt.com")
...
pyperclip.copy("Morgana.00@")  # Contraseña incorrecta
pyautogui.hotkey("ctrl", "v")
time.sleep(1)
...
print("🚀 Test de login con email y contraseña incorrectos completado.")
